...
misc_classes.Text("It has been a crazily long day, and all you need is a good night's rest. You close your eyes, letting exhaustion finally take a grasp of your body and mind, and you finally fall asleep.")
misc_classes.Text("...")
