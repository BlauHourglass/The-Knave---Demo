...
while True:
	print(f"Do you approach the stranger, wait until {character_creation.pronoun.lower()} leaves, or just ignore {character_creation.addressed_pronoun.lower()} and access the water?")
	...
	match demo_stranger_choice:
		case "1":
			...
			prompt = misc_classes.Text(f"The stranger blinks before giving a short sigh. \"That's obvious,\" {character_creation.pronoun.lower()} mutters, rising to {character_creation.possessive_pronoun.lower()} feet. {character_creation.pronoun} hastens to your side and helps you hobble to the side of the river.")
